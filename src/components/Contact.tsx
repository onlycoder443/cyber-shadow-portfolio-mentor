        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">Alagu Nagar, Mengles Road, Dindigul - 624003</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gray-900/70 border-gray-800 p-8 backdrop-blur-sm">
            ...
            <div className="space-y-4">
              ...
              />
              <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white py-3 rounded-lg transition-all duration-300">
